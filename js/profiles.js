      ...
      <!-- Last Raid -->
        ...
        <div class="raid-overview">
            <span class="raid-result 
                ...
                player.isTransition ? `<i class='bx bx-loader-alt bx-spin'></i> In Transit (${player.lastRaidMap} <em class='bx bxs-chevrons-right'></em> ${player.lastRaidTransitionTo || 'Unknown'})` : 
